 ...
 */
#[Command]
class EasySeederRun extends BaseCommand
{
    use Confirmable;
     ...
     */
    protected ?string $name = 'easy:seeder-run';
    ...
    public function __construct(Seed $seed)
    {
        ...
        $this->setDescription('The run seeder class of EasyCMF module');
    }
