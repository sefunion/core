 ...
 */
#[Command]
class EasyMigrate extends BaseCommand
{
    protected $module;
     ...
     */
    public function __construct(EasyMigrationCreator $creator)
    {
        parent::__construct('easy:migrate-gen');
        $this->setDescription('Generate a new EasyCMF module migration file');
