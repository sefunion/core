...
/**
 * Class EasyMigrateRollback.
 */
#[Command]
class EasyMigrateRollback extends BaseCommand
{
    use Confirmable;

    protected ?string $name = 'easy:migrate-rollback';
    ...
    public function __construct(Migrator $migrator)
    {
        ...
        $this->setDescription('The run migrate rollback class of EasyCMF module');
    }
