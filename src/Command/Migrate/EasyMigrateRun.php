...
/**
 * Class EasyMigrateRun.
 */
#[Command]
class EasyMigrateRun extends BaseCommand
{
    use Confirmable;

    protected ?string $name = 'easy:migrate-run';
    ...
    public function __construct(Migrator $migrator)
    {
        ...
        $this->setDescription('The run migrate class of EasyCMF module');
    }
