 ...
 */
#[Command]
class ModuleCommand extends EasyCommand
{
    use Confirmable;
     ...
     * 安装命令.
     */
    protected ?string $name = 'easy:module';
    ...
    {
        parent::configure();
        $this->easy = make(Easy::class);
        $this->setHelp('run "php bin/hyperf.php easy:module --name cms --option install"');
        $this->setDescription('install command of module EasyCMF');
        $this->addOption(
            'option',
            null,
